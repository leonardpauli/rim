...
// exploration of view / data separation using rim -> js
...
const Sudoku = {}
Sudoku.__name = 'Sudoku'
Sudoku.inner = {}; Sudoku.inner.side = 3
Sudoku.outer = {}; Sudoku.outer.side = 3
Sudoku.total = {}; Sudoku.total.side = Sudoku.inner.side * Sudoku.outer.side
Sudoku.maxNr = Sudoku.total.side
Sudoku.values = {}; Sudoku.values.raw = [null, 7, null, 2, 5, null, 4, null, null, 8, null, null, null, null, null, 9, null, 3, null, null, null, null, null, 3, null, 7, null, 7, null, null, null, null, 4, null, 2, null, 1, null, null, null, null, null, null, null, 7, null, 4, null, 5, null, null, null, null, 8, null, 9, null, 6, null, null, null, null, null, 4, null, 1, null, null, null, null, null, 5, null, null, 7, null, 8, 2, null, 3, null]
Sudoku.leftFilter = {}; Sudoku.leftFilter.value = null // is Number{range: 1..maxNr} or null
;((Sudoku.leftFilter.options = {}).available = {}).max = null // is Number{range: 0..maxNr} or null

Sudoku.availableValues = it=> range(1, Sudoku.maxNr).filter(v=> !isIn(v, it))
Sudoku.Box = (()=> {
	const Box = {}
	...
	Box.inits.push({arg: {index: null, value: null}, handler: Self=> ({index, value})=> Object.assign(Self.copy, {index, value})})
	Box.index = 0 // is Number.Int // TODO: shouldn't have default + throw if init'ed without value
	Box.value = null // is Number{range: 1..maxNr} or null

	Box.total = {}
	Box.total.x = mod(Box.index, Sudoku.total.side)
	Box.total.y = div(Box.index, Sudoku.total.side)
